...
function SettingsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            const getUser = {
                "SettingsPage.useEffect.getUser": async ()=>{
            ...
            }["SettingsPage.useEffect.getUser"];
            getUser();
        }
    }["SettingsPage.useEffect"], []);
    const handleUploadAvatar = async (event)=>{
        try {
            ...
            if (file.size > 2 * 1024 * 1024) {
                throw new Error("图片太大了，请上传小于 2MB 的图片");
            }
            ...
            console.log("获取到链接:", publicUrl);
            setAvatarUrl(publicUrl);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("图片上传成功！别忘了点下方的【保存修改】");
        } catch (error) {
            console.error("总错误:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`上传失败: ${error.message}`);
        } finally{
            setUploading(false);
        }
    };
    const handleSave = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`保存失败: ${error.message}`);
        } finally{
            setLoading(false);
        }
    };
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "支持 JPG, PNG, GIF (最大 2MB)"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/settings/page.tsx",
                                                        lineNumber: 165,
                                                        columnNumber: 19
...
_s(SettingsPage, "7mPUh2p7Frzr2ifjXFrs+BnBv+w=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=_e9df013f._.js.map