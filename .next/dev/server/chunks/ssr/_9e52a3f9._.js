...
function SettingsPage() {
    ...
    const handleUploadAvatar = async (event)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("图片上传成功！别忘了点下方的【保存修改】");
        } catch (error) {
            console.error("总错误:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`上传失败: ${error.message}`);
        } finally{
            setUploading(false);
        }
    };
    const handleSave = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`保存失败: ${error.message}`);
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_9e52a3f9._.js.map