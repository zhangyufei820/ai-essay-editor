...
describe("GPT Image V11 parameter mapping", () => {
  ...
  it("keeps Image 2 direct gateway sizes normalized before submission", () => {
    ...
    expect(routeSource).toContain("function normalizeNewApiImageModel")
    expect(routeSource).toContain('return "gpt-image-2-4K"')
    expect(routeSource).toContain("const NEW_API_IMAGE_MODEL = normalizeNewApiImageModel(process.env.SHENXIANG_NEW_API_IMAGE_MODEL)")
    expect(routeSource).toContain("function getImageGatewayCandidates")
