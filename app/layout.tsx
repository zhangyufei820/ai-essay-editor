  ...
  return (
    <html lang="zh-CN">
      ...
      <body className={`font-sans antialiased`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[var(--ink-900)] focus:text-white focus:rounded-[var(--radius-soft)] focus:text-sm focus:font-medium focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--ink-500)]"
        >
          跳转到主要内容
        </a>
