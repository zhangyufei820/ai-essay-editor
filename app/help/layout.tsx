...
const FAQ_SCHEMA = {
  ...
  'mainEntity': [
    ...
    },
    {
      ...
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': '积分是沈翔智学的虚拟货币，可以用于文本生成、作文批改、图片生成、音乐创作等付费功能。新用户注册即送 1000 积分。',
      },
    },
    {
      '@type': 'Question',
      ...
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': '文本生成按实际输入和输出内容计费：输入内容 5 积分 / 1K tokens，输出内容 20 积分 / 1K tokens。输入和输出都会消耗积分，输出越长消耗越多。系统会在回复完成后，根据实际 token 用量扣除积分；无实际输出内容不扣文本生成费用。',
      },
    },
    {
      '@type': 'Question',
