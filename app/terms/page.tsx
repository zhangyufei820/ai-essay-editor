        ...
        <section className="mb-12">
          ...
          <div className="bg-[var(--paper-50)] rounded-[var(--radius-sharp)] p-8" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
            ...
            <div className="mt-6 space-y-3" style={{ color: "var(--ink-600)" }}>
              ...
              <p>
                退款规则、审核周期和到账时间以
                <Link href="/refund-policy" className="underline mx-1" style={{ color: "var(--ink-700)" }}>
                  退款政策
                </Link>
                为准。
              </p>
          ...
          <div className="bg-[var(--paper-50)] rounded-[var(--radius-sharp)] p-8" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
            <div className="space-y-4" style={{ color: "var(--ink-600)" }}>
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 mt-1 shrink-0" style={{ color: "var(--ink-600)" }} />
                <div>
                  <h3 className="font-semibold mb-1" style={{ color: "var(--ink-800)" }}>账户注册</h3>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 mt-1 shrink-0" style={{ color: "var(--ink-600)" }} />
                <div>
                  <h3 className="font-semibold mb-1" style={{ color: "var(--ink-800)" }}>账户安全</h3>
              ...
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 mt-1 shrink-0" style={{ color: "var(--ink-600)" }} />
                <div>
                  <h3 className="font-semibold mb-1" style={{ color: "var(--ink-800)" }}>账户注销</h3>
          ...
          <div className="bg-[var(--paper-50)] rounded-[var(--radius-sharp)] p-8" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
            ...
            <ul className="space-y-3" style={{ color: "var(--ink-600)" }}>
              <li className="flex items-start gap-2">
                <XCircle className="w-5 h-5 mt-1 shrink-0 text-[var(--seal-500)]" />
