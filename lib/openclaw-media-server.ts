...
export function rewriteOpenClawMediaReferencesWithSignedUrls(
  ...
  return text
    .replace(/https?:\/\/(?:43\.154\.111\.156|shenxiang\.school|www\.shenxiang\.school|school\.shenxiang\.school|api\.shenxiang\.school|cloudflare\.shenxiang\.school|localhost|127\.0\.0\.1)(?::18789)?\/__openclaw__\/media\/([^\s)"'<>`]+)/g, (_match, mediaPath: string) =>
