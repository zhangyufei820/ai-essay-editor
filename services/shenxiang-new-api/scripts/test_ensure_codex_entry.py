...
""",
    ...
    def test_ensure_codex_image_model_limits_adds_only_public_15k_image_model(self) -> None:
        ...
        self.assertEqual(
            ...
            "gpt-5.4-mini,gpt-5.5,gpt-5.4,gpt-5.6-terra,gpt-5.6-sol,kimi-k3,gpt-5.5-openai-compact,image 2电商商品图快速通道(1.5K)",
        )
    ...
    def test_ensure_codex_image_model_limits_defaults_empty_to_text_and_image(self) -> None:
        ...
        self.assertEqual(
            self.module.ensure_codex_image_model_limits(raw),
            "gpt-5.5,gpt-5.4,gpt-5.4-mini,gpt-5.6-terra,gpt-5.6-sol,kimi-k3,gpt-5.5-openai-compact,image 2电商商品图快速通道(1.5K)",
        )
