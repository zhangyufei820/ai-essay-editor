...
""",
    ...
    def test_sanitize_model_limits_replaces_raw_gpt_image2(self) -> None:
        ...
        self.assertEqual(
            ...
            "gpt-image-2-4K,gpt-5.5,codex-auto-review",
        )
    ...
    def test_ensure_codex_image_model_limits_adds_only_public_15k_image_model(self) -> None:
        ...
        self.assertEqual(
            ...
            "gpt-5.4-mini,gpt-5.5,gpt-5.4,gpt-5.6-terra,gpt-5.6-sol,gpt-6-astra,kimi-k3,gpt-5.5-openai-compact,image 2电商商品图快速通道(1.5K)",
        )
    ...
    def test_ensure_codex_image_model_limits_defaults_empty_to_text_and_image(self) -> None:
        ...
        self.assertEqual(
            self.module.ensure_codex_image_model_limits(raw),
            "gpt-5.5,gpt-5.4,gpt-5.4-mini,gpt-5.6-terra,gpt-5.6-sol,gpt-6-astra,kimi-k3,gpt-5.5-openai-compact,image 2电商商品图快速通道(1.5K)",
        )
    ...
    def test_claude_models_are_publicly_listed_with_marketplace_only_terminal_group(self) -> None:
        ...
        pricing_table = (source_root / "web/classic/src/components/table/model-pricing/modal/components/ModelPricingTable.jsx").read_text(encoding="utf-8")
        pricing_groups = (source_root / "web/classic/src/components/table/model-pricing/filter/PricingGroups.jsx").read_text(encoding="utf-8")

        self.assertIn("service.ClaudeKiroPricingGroupName", pricing)
        self.assertIn("service.ClaudeKiroStablePricingGroupName", pricing)
        self.assertIn("service.ClaudeTerminalPricingGroupName", pricing)
        self.assertIn("service.ClaudeExternalPricingGroupName", pricing)
        self.assertIn("service.GetMarketplacePricingGroups(group, managedGrok45Visible)", pricing)
        ...
        self.assertIn("const availableGroups = modelEnableGroups", pricing_table)
