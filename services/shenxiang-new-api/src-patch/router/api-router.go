...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/models", middleware.UserAuth(), controller.DashboardListVisibleModels)
		...
		apiRouter.POST("/oauth/telegram/login", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.TelegramLogin)
		apiRouter.POST("/oauth/telegram/bind", middleware.CriticalRateLimit(), middleware.UserAuth(), anonymousRequestBodyLimit, controller.TelegramBind)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/image-benefit", controller.GetImageBenefitSelf)
		...
		tokenRoute.Use(middleware.UserAuth(), middleware.EnforcePublicTokenGroupSelection())
		{
