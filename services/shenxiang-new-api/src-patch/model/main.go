...
func InitDB() (err error) {
	...
	if err == nil {
		...
		if !common.IsMasterNode {
			...
			return WaitForTaskPublicIDUniqueIndex(time.Duration(common.GetEnvOrDefault("DB_SCHEMA_READY_TIMEOUT", 60)) * time.Second)
		}
		if common.UsingMainDatabase(common.DatabaseTypeMySQL) {
...
func migrateDB() error {
	...
	if err := EnsureTaskPublicIDUniqueIndex(); err != nil {
		return err
	}
	return EnsureUserOAuthIdentityUniqueIndexes()
}
...
func migrateDBFast() error {
	...
	if err := EnsureUserOAuthIdentityUniqueIndexes(); err != nil {
		return err
	}
