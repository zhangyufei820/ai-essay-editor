...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&Channel{}, "Channel"},
		{&Token{}, "Token"},
		{&TokenQuotaWindow{}, "TokenQuotaWindow"},
		{&User{}, "User"},
...
` + "`monthly_amount_total`" + ` bigint NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "monthly_amount_total", DDL: "`monthly_amount_total` bigint NOT NULL DEFAULT 0"},
