...
func HandleGroupRatio(ctx *gin.Context, relayInfo *relaycommon.RelayInfo) types.GroupRatioInfo {
	...
	if service.IsKimiK3PricingGroup(relayInfo) {
...
func imageFixedPriceCNY(meta *types.TokenCountMeta) float64 {
	if meta == nil || meta.ImagePriceCNY <= 0 {
		return 0
	}
	return meta.ImagePriceCNY
}

func usdExchangeRateForBilling() float64 {
