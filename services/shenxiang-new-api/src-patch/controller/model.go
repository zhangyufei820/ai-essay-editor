...
func ListModels(c *gin.Context, modelType int) {
	...
	if service.IsMonthlyCardTokenName(c.GetString("token_name")) {
		monthlyModels, err := service.MonthlyCardChannelModelsForUser(c.GetInt("id"))
		if err != nil {
			common.SysError("monthly card model list unavailable: " + err.Error())
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": "monthly card channel models unavailable",
			})
			return
		}
		userModelNames = append(userModelNames, monthlyModels...)
