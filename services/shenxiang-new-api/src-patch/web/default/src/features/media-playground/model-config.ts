...
export const MEDIA_MODEL_CONFIGS: ModelCapability[] = [
  ...
  },
  {
    ...
    label: 'GPT Image 2.5 Flare · 快速生成',
    kind: 'image',
    vendorLabel: '星人图像',
    endpoint: '/v1/images/generations',
    description: '官方定位为最快的高质量日常图像生成，适合快速原型、日常创作与批量生成。',
    supportsEdit: false,
    sizes: ['1024x1024'],
    aspectRatios: ['1:1'],
    resolutions: ['auto'],
    ...
    defaultResolution: 'auto',
    defaultQuality: 'auto',
    notes: ['快速生成模型；仅开放已验证的 1024×1024 单张文生图，不发送未确认的质量或编辑参数。', '人民币固定 ¥0.17/张。'],
  },
  {
    id: 'gpt-image-2.5-sunburst',
    label: 'GPT Image 2.5 Sunburst · 精细编辑',
    kind: 'image',
    vendorLabel: '星人图像',
    endpoint: '/v1/images/generations',
    description: '官方定位为重视编辑精度与细节控制的高端创作工作流，适合成片级创意与精细产品图。',
    supportsEdit: false,
    sizes: ['1024x1024'],
    aspectRatios: ['1:1'],
    resolutions: ['auto'],
    ...
    defaultResolution: 'auto',
    defaultQuality: 'auto',
    notes: ['精细编辑定位；当前仅开放已验证的 1024×1024 单张文生图，上传编辑入口待上游实测后再开放。', '人民币固定 ¥0.17/张。'],
  },
  {
