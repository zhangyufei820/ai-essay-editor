...
import ChannelsConsoleToolbar from './ChannelsConsoleToolbar';
...
const ChannelsPage = () => {
  ...
  return (
    <div className='channel-console'>
      ...
      <header className='channel-console__header'>
        <div className='channel-console__title-group'>
          <h1 id='channel-console-title' className='channel-console__title'>
            {channelsData.t('渠道管理')}
          </h1>
          <span className='channel-console__count' aria-live='polite'>
            {channelsData.channelCount}
          </span>
        </div>
      </header>
      ...
      <section
        className='channel-console-surface'
        aria-label={channelsData.t('渠道列表')}
      >
        <div className='channel-console-tabs'>
          <ChannelsTabs {...channelsData} />
        </div>
        <ChannelsConsoleToolbar {...channelsData} />
        <div className='channel-console-table'>
          <ChannelsTable {...channelsData} />
        </div>
        <footer className='channel-console__footer'>
