...
const sanitizeHtml = (html) => {
  ...
  const content = bodyContent ? bodyContent.innerHTML : sanitizedHtml;

  return { content: DOMPurify.sanitize(content), styles: '' };
};
          ...
          <div className='bg-white rounded-lg shadow-sm p-8'>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(htmlPayload.content),
              }}
            />
          </div>
        </div>
