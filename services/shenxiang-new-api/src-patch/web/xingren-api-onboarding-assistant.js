(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".xr-api-assistant-panel{position:fixed;right:20px;top:64px;bottom:20px;width:min(520px,calc(100vw - 40px));background:#ffffff;border:1px solid #d1d5db;border-radius:12px;box-shadow:0 28px 90px rgba(15,23,42,.26);display:flex;flex-direction:column;overflow:hidden}",
