...
func TestDiscountImage2NamesAreRetired(t *testing.T) {
	require.True(t, IsRetiredImageModelName(PublicDiscountImage2ModelName))
	require.True(t, IsRetiredImageModelName(InternalDiscountImage2ModelName))
