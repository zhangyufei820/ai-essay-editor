	...
	return []SystemTokenProfile{
		{
			Mode:   "codex",
			Name:   "星人 Codex 文本令牌",
			Models: []string{"gpt-5.5", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.6-terra", "gpt-5.6-sol", "gpt-6-astra", "gpt-6-sol", "gpt-5.5-openai-compact", "codex-auto-review", codexImage15KModelName},
		},
		{
			Mode:   "claude",
		...
		},
		{
			Mode:   "image",
			Name:   "星人图像生成令牌",
			Models: []string{"gpt-image-2-4K", PublicDiscountImage2ModelName, PublicStableImage2ModelName, "grok-imagine-image", "grok 4.6图片", "banana-2", "gemini-3-pro-image-preview", "gemini-3.1-flash-image", "gemini-3-pro-image", "gpt-image-2.5-flare", "gpt-image-2.5-sunburst", "ecommerce-banana-2", codexImage15KModelName},
		},
		{
			Mode:   "video",
			Name:   "星人视频生成令牌",
