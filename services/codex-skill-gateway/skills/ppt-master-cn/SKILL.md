---
name: ppt-master-cn
display_name: PPT 生成大师
description: >
  中文云端 Codex 版 PPT Master。用于把 PDF/DOCX/XLSX/URL/Markdown/主题资料生成高质量、
  可编辑 PowerPoint PPTX，支持模板、SVG 页面、原生形状导出和视觉质检。用户说“生成PPT”、
  “做PPT”、“制作演示文稿”、“make presentation”或需要可编辑 PPTX 时使用。
---

# PPT 生成大师

这是 `hugohe3/ppt-master` 的云端 Codex 内置版本，已按 shenxiang.school 主站 Codex Skill Gateway 注册为中文 Skill。

- 上游仓库：https://github.com/hugohe3/ppt-master
- 上游提交：`313ee6729dba50cbdd50b67debe601c483a5bcab`
- 云端内部 Skill ID：`ppt-master-cn`
- 用户展示名：`PPT 生成大师`
