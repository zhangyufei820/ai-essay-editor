...
import { IconBanzhuren, IconEnglish, IconTeaching } from "@/components/icons/v2"
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 pt-32 pb-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[var(--ink-50)] px-4 py-2 text-sm font-medium text-[var(--ink-700)]">
            <IconTeaching className="h-4 w-4" />
            全学段·全学科·AI驱动
          </div>
          ...
          <h1 className="mb-6 text-5xl font-bold tracking-tight text-balance md:text-6xl lg:text-7xl">
            智能教育平台
            <br />
            <span className="text-[var(--ink-700)]">点亮每一个学习梦想</span>
          </h1>
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-0 -translate-x-1/2 transform">
          <div className="h-[600px] w-[600px] rounded-full bg-[var(--ink-50)] blur-3xl" />
        </div>
      </div>
    </section>
  )
