              ...
              <Link key={level.id} href={level.href}>
                <Card className="group relative h-full overflow-hidden rounded-[var(--radius-sharp)] border-2 border-[var(--paper-200)]/50 bg-[var(--paper-50)] p-8 shadow-lg transition-all duration-300 hover:border-[var(--ink-500)] hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-1">
                  ...
                  <div className="relative">
                    <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-[var(--radius-sharp)] bg-gradient-to-br from-primary/20 to-primary/10 text-[var(--ink-700)] shadow-md transition-all duration-300 group-hover:scale-110 group-hover:bg-[var(--seal-500)] group-hover:text-white group-hover:shadow-lg">
                      <Icon className="h-7 w-7" />
                    </div>

                    <h3 className="mb-3 text-xl font-bold">{level.title}</h3>
                    <p className="mb-6 text-sm text-[var(--ink-500)] leading-relaxed">{level.description}</p>
