  ...
  return (
    ...
    >
      ...
      {image ? (
        ...
        <label
          htmlFor={inputId}
          className="flex w-full cursor-pointer flex-col items-center justify-center rounded-[var(--radius-soft)] px-4 py-7 text-center transition hover:bg-[var(--paper-100)]"
        >
            ...
            <div className="flex flex-wrap gap-2">
              <Button type="button" variant="outline" size="sm" asChild>
                <label
                  ...
                  className={[
                    "cursor-pointer",
                    images.length >= MAX_EDIT_IMAGE_UPLOADS ? "pointer-events-none opacity-50" : "",
                  ].join(" ")}
                  aria-disabled={images.length >= MAX_EDIT_IMAGE_UPLOADS}
                >
