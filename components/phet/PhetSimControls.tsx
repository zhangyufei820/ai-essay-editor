...
export function PhetSimControls({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-emerald-900/10 bg-white/92 px-3 py-2 backdrop-blur dark:border-emerald-200/10 dark:bg-slate-950/92">
